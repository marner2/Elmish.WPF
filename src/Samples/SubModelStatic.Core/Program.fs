...
type [<AllowNullLiteral>] CounterViewModel (args) as this =
  ...
  new() = CounterViewModel(Counter.init |> ViewModelArgs.fake)
...
type [<AllowNullLiteral>] ClockViewModel (args) as this =
  ...
  new() = ClockViewModel(Clock.init () |> ViewModelArgs.fake)
...
type [<AllowNullLiteral>] CounterWithClockViewModel (args) as this =
  ...
  new() = CounterWithClockViewModel(CounterWithClock.init () |> ViewModelArgs.fake)
...
type [<AllowNullLiteral>] AppViewModel (args) as this =
  ...
  new() = AppViewModel(App2.init () |> ViewModelArgs.fake)
